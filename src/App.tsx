  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      <section className="relative bg-gradient-to-r from-green-700 to-blue-700 text-white py-20 text-center overflow-hidden">
        ...
        <div className="relative flex justify-center gap-4">
          <button className="bg-white text-green-700 font-semibold px-6 py-3 rounded-xl shadow-md hover:bg-gray-100 transition">
            Order Online
          </button>
          <button className="bg-yellow-400 text-gray-900 font-semibold px-6 py-3 rounded-xl shadow-md hover:bg-yellow-300 transition">
            Contact Us
          </button>
        </div>
      </section>
